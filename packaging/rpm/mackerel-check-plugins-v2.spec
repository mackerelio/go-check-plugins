...
- Bump golang.org/x/sys from 0.42.0 to 0.43.0 in the golang-x group (by dependabot[bot])
- Bump github.com/mackerelio/checkers from 0.2.0 to 0.2.1 in the mackerelio group (by dependabot[bot])
...
- Bump the aws-aws-sdk-go-v2 group with 3 updates (by dependabot[bot])
- Bump github.com/elazarl/goproxy from 1.8.2 to 1.8.3 in the testlibs group (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs from 1.65.0 to 1.66.0 in the aws-aws-sdk-go-v2 group (by dependabot[bot])
...
- Bump github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs from 1.64.1 to 1.64.2 in the aws-aws-sdk-go-v2 group (by dependabot[bot])
...
- Bump golang.org/x/crypto from 0.48.0 to 0.49.0 in the golang-x group (by dependabot[bot])
- Bump the aws-aws-sdk-go-v2 group with 5 updates (by dependabot[bot])
- Bump golang.org/x/text from 0.34.0 to 0.35.0 in the golang-x group (by dependabot[bot])
- Use Go toolchain (or mod) version in CI build process (by ne-sachirou)
- Bump github.com/mackerelio/go-osstat from 0.2.6 to 0.2.7 in the mackerelio group (by dependabot[bot])
- Bump golang.org/x/sys from 0.41.0 to 0.42.0 in the golang-x group (by dependabot[bot])
- Bump the aws-aws-sdk-go-v2 group with 5 updates (by dependabot[bot])
...
- Bump the aws-aws-sdk-go-v2 group with 2 updates (by dependabot[bot])
- Bump github.com/elazarl/goproxy from 1.8.1 to 1.8.2 in the testlibs group (by dependabot[bot])
- Bump github.com/lib/pq from 1.11.1 to 1.11.2 (by dependabot[bot])
- Bump the golang-x group with 3 updates (by dependabot[bot])
- Bump github.com/elazarl/goproxy from 1.8.0 to 1.8.1 in the testlibs group (by dependabot[bot])
...
* Mon Feb 2 2026 <mackerel-developers@hatena.ne.jp> - 0.52.0
- [check-windows-eventlog] test: fix the OS thread between CoInitialize and CoUninitialize (by Arthur1)
- Support formatting return value of check-windows-eventlog (by appare45)
- Bump github.com/miekg/dns from 1.1.70 to 1.1.72 (by dependabot[bot])
- Bump actions/checkout from 6.0.1 to 6.0.2 (by dependabot[bot])
- Bump github.com/elazarl/goproxy from 1.7.2 to 1.8.0 in the testlibs group (by dependabot[bot])
- Bump actions/cache from 5.0.1 to 5.0.2 (by dependabot[bot])
- Bump golang.org/x/crypto from 0.46.0 to 0.47.0 in the golang-x group (by dependabot[bot])
- Bump actions/setup-go from 6.1.0 to 6.2.0 (by dependabot[bot])
- Bump golang.org/x/text from 0.32.0 to 0.33.0 in the golang-x group (by dependabot[bot])
- Bump github.com/miekg/dns from 1.1.69 to 1.1.70 (by dependabot[bot])
- Bump the aws-aws-sdk-go-v2 group with 5 updates (by dependabot[bot])
- Bump golang.org/x/sys from 0.39.0 to 0.40.0 in the golang-x group (by dependabot[bot])
...
- Bump actions/cache from 4.3.0 to 5.0.1 (by dependabot[bot])
- Bump github.com/miekg/dns from 1.1.68 to 1.1.69 (by dependabot[bot])
- Bump the aws-aws-sdk-go-v2 group with 2 updates (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs from 1.62.2 to 1.63.0 in the aws-aws-sdk-go-v2 group (by dependabot[bot])
