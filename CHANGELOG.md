...
* Bump actions/setup-go from 6.5.0 to 7.0.0 #1085 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group with 4 updates #1084 (dependabot[bot])
* Bump the golang-x group across 1 directory with 3 updates #1083 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group with 2 updates #1082 (dependabot[bot])
* Bump github.com/mackerelio/go-osstat from 0.2.7 to 0.2.8 in the mackerelio group across 1 directory #1080 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group with 4 updates #1078 (dependabot[bot])
* Bump golang.org/x/text from 0.38.0 to 0.39.0 in the golang-x group #1077 (dependabot[bot])
* Change Dependabot schedule from daily to weekly #1076 (yseto)
* Bump the aws-aws-sdk-go-v2 group with 5 updates #1075 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group with 4 updates #1074 (dependabot[bot])
* Bump actions/cache from 5.0.5 to 6.1.0 #1073 (dependabot[bot])
* Bump actions/setup-go from 6.4.0 to 6.5.0 #1072 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs from 1.76.0 to 1.78.0 in the aws-aws-sdk-go-v2 group #1071 (dependabot[bot])
* Bump actions/checkout from 6.0.3 to 7.0.0 #1070 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs from 1.75.2 to 1.76.0 in the aws-aws-sdk-go-v2 group #1069 (dependabot[bot])
* Bump the golang-x group with 2 updates #1068 (dependabot[bot])
* added IMDSTimeout on check-aws-cloudwatch-logs #1063 (yseto)
* Bump the aws-aws-sdk-go-v2 group across 1 directory with 5 updates #1062 (dependabot[bot])


## 0.52.3 (2026-06-09)

* Bump the golang-x group across 1 directory with 2 updates #1066 (dependabot[bot])
* Bump actions/checkout from 6.0.2 to 6.0.3 #1065 (dependabot[bot])
* Bump github.com/fsouza/go-dockerclient from 1.13.1 to 1.13.2 #1064 (dependabot[bot])
* Bump the golang-x group across 1 directory with 2 updates #1060 (dependabot[bot])
* Bump github.com/elazarl/goproxy from 1.8.3 to 1.8.4 in the testlibs group #1059 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group with 2 updates #1058 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs from 1.73.0 to 1.74.0 in the aws-aws-sdk-go-v2 group #1057 (dependabot[bot])
* Bump golang.org/x/text from 0.36.0 to 0.37.0 in the golang-x group #1055 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs from 1.71.1 to 1.73.0 in the aws-aws-sdk-go-v2 group #1054 (dependabot[bot])
* Bump golang.org/x/sys from 0.43.0 to 0.44.0 in the golang-x group across 1 directory #1053 (dependabot[bot])
* remove use a io/ioutil #1052 (yseto)
* Bump github.com/go-sql-driver/mysql from 1.9.3 to 1.10.0 #1051 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group across 1 directory with 5 updates #1050 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs from 1.69.1 to 1.70.0 in the aws-aws-sdk-go-v2 group #1048 (dependabot[bot])
* Bump github.com/Azure/go-ntlmssp from 0.1.0 to 0.1.1 #1047 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group with 5 updates #1046 (dependabot[bot])
* Bump actions/cache from 5.0.4 to 5.0.5 #1045 (dependabot[bot])
...
* Go 1.26 #1038 (mechairoi)
* Bump github.com/lib/pq from 1.12.1 to 1.12.3 #1037 (dependabot[bot])
* Bump golang.org/x/sys from 0.42.0 to 0.43.0 in the golang-x group #1036 (dependabot[bot])
* Bump github.com/mackerelio/checkers from 0.2.0 to 0.2.1 in the mackerelio group #1034 (dependabot[bot])
* Bump github.com/lib/pq from 1.12.0 to 1.12.1 #1033 (dependabot[bot])
* Bump github.com/fsouza/go-dockerclient from 1.13.0 to 1.13.1 #1032 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group with 3 updates #1031 (dependabot[bot])
* Bump github.com/elazarl/goproxy from 1.8.2 to 1.8.3 in the testlibs group #1030 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs from 1.65.0 to 1.66.0 in the aws-aws-sdk-go-v2 group #1029 (dependabot[bot])
* Bump actions/setup-go from 6.3.0 to 6.4.0 #1028 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group with 5 updates #1027 (dependabot[bot])
* Bump github.com/moby/moby/v2 from 2.0.0-beta.6 to 2.0.0-beta.8 #1026 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs from 1.64.1 to 1.64.2 in the aws-aws-sdk-go-v2 group #1025 (dependabot[bot])
* Bump actions/cache from 5.0.3 to 5.0.4 #1024 (dependabot[bot])
* Bump github.com/lib/pq from 1.11.2 to 1.12.0 #1023 (dependabot[bot])
* Bump github.com/go-ldap/ldap/v3 from 3.4.12 to 3.4.13 #1022 (dependabot[bot])
* Bump actions/download-artifact from 8.0.0 to 8.0.1 #1021 (dependabot[bot])
* Bump golang.org/x/crypto from 0.48.0 to 0.49.0 in the golang-x group #1020 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group with 5 updates #1019 (dependabot[bot])
* Bump golang.org/x/text from 0.34.0 to 0.35.0 in the golang-x group #1018 (dependabot[bot])
* Use Go toolchain (or mod) version in CI build process #1017 (ne-sachirou)
* Bump github.com/mackerelio/go-osstat from 0.2.6 to 0.2.7 in the mackerelio group #1016 (dependabot[bot])
* Bump golang.org/x/sys from 0.41.0 to 0.42.0 in the golang-x group #1015 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group with 5 updates #1014 (dependabot[bot])
* Bump actions/upload-artifact from 6.0.0 to 7.0.0 #1013 (dependabot[bot])
* Bump actions/setup-go from 6.2.0 to 6.3.0 #1012 (dependabot[bot])
* Bump mackerelio/workflows/.github/workflows/setup-go-matrix.yml from 1.8.0 to 1.9.0 #1011 (dependabot[bot])
* Bump mackerelio/workflows/.github/workflows/go-test.yml from 1.8.0 to 1.9.0 #1010 (dependabot[bot])
* Bump mackerelio/workflows/.github/workflows/go-lint.yml from 1.8.0 to 1.9.0 #1009 (dependabot[bot])
* Bump actions/download-artifact from 7.0.0 to 8.0.0 #1008 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group with 5 updates #1007 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group with 2 updates #1006 (dependabot[bot])
* Bump filippo.io/edwards25519 from 1.1.0 to 1.1.1 #1005 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group with 2 updates #1004 (dependabot[bot])
* Bump github.com/elazarl/goproxy from 1.8.1 to 1.8.2 in the testlibs group #1003 (dependabot[bot])
* Bump github.com/lib/pq from 1.11.1 to 1.11.2 #1002 (dependabot[bot])
* Bump the golang-x group with 3 updates #1001 (dependabot[bot])
* Bump github.com/elazarl/goproxy from 1.8.0 to 1.8.1 in the testlibs group #1000 (dependabot[bot])
* Bump github.com/fsouza/go-dockerclient from 1.12.3 to 1.13.0 #999 (dependabot[bot])
* Bump actions/cache from 5.0.2 to 5.0.3 #998 (dependabot[bot])
* Bump github.com/lib/pq from 1.10.9 to 1.11.1 #997 (dependabot[bot])
